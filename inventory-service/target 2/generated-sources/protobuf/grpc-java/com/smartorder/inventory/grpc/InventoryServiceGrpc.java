...
public final class InventoryServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.smartorder.inventory.grpc.InventoryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.smartorder.inventory.grpc.StockRequest,
      com.smartorder.inventory.grpc.StockResponse> getCheckStockMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckStock",
      requestType = com.smartorder.inventory.grpc.StockRequest.class,
      responseType = com.smartorder.inventory.grpc.StockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.smartorder.inventory.grpc.StockRequest,
      com.smartorder.inventory.grpc.StockResponse> getCheckStockMethod() {
    io.grpc.MethodDescriptor<com.smartorder.inventory.grpc.StockRequest, com.smartorder.inventory.grpc.StockResponse> getCheckStockMethod;
      ...
      synchronized (InventoryServiceGrpc.class) {
        if ((getCheckStockMethod = InventoryServiceGrpc.getCheckStockMethod) == null) {
          InventoryServiceGrpc.getCheckStockMethod = getCheckStockMethod =
              io.grpc.MethodDescriptor.<com.smartorder.inventory.grpc.StockRequest, com.smartorder.inventory.grpc.StockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckStock"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartorder.inventory.grpc.StockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartorder.inventory.grpc.StockResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void checkStock(com.smartorder.inventory.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.smartorder.inventory.grpc.StockResponse> responseObserver) {
  ...
  public static final class InventoryServiceStub
    ...
    /**
     */
    public void checkStock(com.smartorder.inventory.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.smartorder.inventory.grpc.StockResponse> responseObserver) {
  ...
  public static final class InventoryServiceBlockingStub
    ...
    /**
     */
    public com.smartorder.inventory.grpc.StockResponse checkStock(com.smartorder.inventory.grpc.StockRequest request) {
  ...
  public static final class InventoryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.smartorder.inventory.grpc.StockResponse> checkStock(
        com.smartorder.inventory.grpc.StockRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_STOCK:
          serviceImpl.checkStock((com.smartorder.inventory.grpc.StockRequest) request,
              (io.grpc.stub.StreamObserver<com.smartorder.inventory.grpc.StockResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.smartorder.inventory.grpc.StockRequest,
              com.smartorder.inventory.grpc.StockResponse>(
  ...
  private static abstract class InventoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.smartorder.inventory.grpc.InventoryProto.getDescriptor();
    }
